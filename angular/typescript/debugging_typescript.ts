...
// The original code WITH errors is commented out one line above the corrected line of code.
...
// put curly brackets after the lambda function, since it is a statement.
...
setTimeout(function(){
 ...
 // Why didn't babar's age change? Fix this by using an arrow function in the Elephant class.
    // Took out function and inserted arrow after ()